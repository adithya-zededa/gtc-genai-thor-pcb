...
from agents.mcp.session import MCPSession, SessionType
...
class MCPExecutor(BaseDomainExecutor):
    ...
    def _handle_send_alert_email(self, args: Dict[str, Any]) -> Dict[str, Any]:
        from agents.tools.general.alert import tool_send_alert_email
        from agents.tools._email_utils import default_recipients
    ...
    def _handle_save_evidence(self, args: Dict[str, Any]) -> Dict[str, Any]:
        from agents.tools.general.evidence import tool_save_evidence
        return tool_save_evidence(
    ...
    def _handle_log_event(self, args: Dict[str, Any]) -> Dict[str, Any]:
        from agents.tools.general.event_log import tool_log_event
        return tool_log_event(
    ...
    def _handle_query_history(self, args: Dict[str, Any]) -> Dict[str, Any]:
        from agents.tools.general.history import tool_query_history
        return tool_query_history(
