...
def logs():
    ...
    if request.method == "DELETE":
        try:
            ...
            return jsonify({
                "success": False,
                "error": f"Failed to clear logs: {exc}"
            }), 500
...
def delete_log(log_id: int):
    ...
    try:
        ...
        return jsonify({
            "success": False,
            "error": f"Failed to delete log: {exc}"
        }), 500
...
def export_logs():
    ...
    try:
        ...
        if format_type == "csv":
            ...
            writer.writerow([
                "Timestamp", "Confidence", "Response", "Image Path", 
                "Frame Number", "Reason", "Vision Description", "Decision Details"
            ])
        ...
        return jsonify({
            "success": False,
            "error": f"Failed to export logs: {exc}"
        }), 500
