...
class StreamlinedAgent:
    ...
    def analyze_agentic(
        ...
        try:
            ...
            # Save detection image if enabled (save all agentic frames for audit trail)
            image_path = ""
            if self.save_images:
    ...
    def process_detection(
        ...
        Args:
            ...
            image_data: Optional raw image bytes for email attachments.
            
        Returns:
            True if any alerts were sent, False otherwise.
        """
