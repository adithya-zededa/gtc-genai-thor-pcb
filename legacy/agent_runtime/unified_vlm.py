...
class UnifiedVLMClient:
    ...
    def _resize_for_inference(self, frame: np.ndarray, max_dimension: int = 1024) -> np.ndarray:
        ...
        Args:
            ...
            max_dimension: Maximum width or height (default 1024px for good quality/speed balance)
    ...
    def _encode_frame(self, frame: np.ndarray) -> str:
        """Encode numpy frame to base64 JPEG with optional resizing for efficiency."""
        # Resize for faster inference while maintaining quality
